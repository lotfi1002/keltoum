    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            <div class="panel-heading">
                    Modofier un  étudiant
            </div>
    <div class="panel-body">
    <div class="row">

     {{-- Using the Laravel HTML Form Collective to create our form --}}
        {{ Form::model($etudiant, array('route' => array('etudiants.update',$etudiant->id) , 'id' => 'form', 'method' => 'PUT')) }}
    <div class="col-lg-6">
         <div class="form-group">
            ...
            <div class="form-group">
            {{ Form::submit('Modifier Etudiant', array('class' => 'btn btn-default')) }}
